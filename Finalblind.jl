...
function Z(a::Int64, sp::Vector, o::Int64)
    if a == -1
        if o==-1
            return 1
        else
    ...
    FinalP2Distribution = copy(P2Distribution)
    return FinalP2Distribution[o+2]
end
...
function update_belief(p::Poker, b::Vector, a::Int64, o::Int64)
    space = create_space(p)
    states = space[1]
    nb = Array{Float64}([])
    for ns in states
...
function simulation(stateV::Int64, obsV::Int64)
